...
const Footer = () => {
  ...
  return (
    <footer id="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-section leftFooter">
          ...
          <p className="footer-description">
            Coming soon to your favorite platforms! Stay tuned for updates.
          </p>
          <div className="app-buttons">
            <a 
              target="_blank" 
              rel="noopener noreferrer"
              href="http://play.google.com/store/games?hl=en"
              className="app-link glass-button"
            ...
            <a 
              target="_blank"
              rel="noopener noreferrer" 
              href="http://www.apple.com/in/app-store/"
              className="app-link glass-button"
        ...
        <div className="footer-section midFooter">
          <div className="brand-container">
            <h1 className="footer-brand">
              <span className="brand-gradient">Ritesh Pandit</span>
            </h1>
            <p className="footer-tagline">AI/ML & Full-Stack Developer</p>
          ...
          <div className="quick-links">
            <a href="/#intro" className="quick-link">Introduction</a>
          ...
          <div className="copyright">
            <p>© {currentYear} Ritesh Pandit. All rights reserved.</p>
      ...
      {/* Back to Top Button */}
      <a href="#header" className="back-to-top" aria-label="Back to top">
